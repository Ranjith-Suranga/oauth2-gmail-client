...
Run `npx lite-server`. 
This usually opens the browser window and automatically navigate to the site. Otherwise,
...
OAuth2 Gmail Client is MIT licensed, as found in the [LICENSE](LICENSE) file.
